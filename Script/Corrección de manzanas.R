...
test = is.na(Casa_mnz_Chap$surface_total)
no_test = is.na(Casa_mnz_Chap$surface_total)==F

p_load(caret)
require(caret)

k1 = knn(train=Casa_mnz_Chap[no_test,c("geometry","surface_total")], ## base de entrenamiento
         test=Casa_mnz_Chap[test,c("geometry","surface_total")],   ## base de testeo
         cl=Casa_mnz_Chap$surface_total[test], ## outcome
         k=1)  
